<div class="main-panel">
                            ...
                            <div class="field_wrapper">
                                <div class="form-group my-0">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <select class="w-100 mr-1" name="asisten[]" id="asisten" required>
                                            <option value="">--Pilih Asisten--</option>
                                            <?php foreach ($asisten_opt as $asisten): ?>
                                                <option value="<?=$asisten['id_user']?>"><?=$asisten['nama_lengkap']?></option>
                                            <?php endforeach ?>
                                        </select>
                                        <a href="javascript:void(0);" class="add_button mt-1" title="Add field"><i class="btn-sm btn-success mdi mdi-plus"></i></a>
                                        <div class="valid-feedback">
    ...
    <script>
        $(document).ready(function(){
            ...
            var fieldHTML = `<div class="d-flex justify-content-between mt-3"><select class="w-100 mr-1" name="asisten[]" id="asisten" required><option value="">--Pilih Asisten--</option><?php foreach ($asisten_opt as $asisten): ?><option value="<?=$asisten['id_user']?>"><?=$asisten['nama_lengkap']?></option><?php endforeach ?></select><a href="javascript:void(0);" class="remove_button mt-1" title="Add field"><i class="btn-sm btn-danger mdi mdi-minus"></i></a></div>`; //New input field html
