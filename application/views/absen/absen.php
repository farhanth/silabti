 ...
 <div class="main-panel">
     <div class="content-wrapper">
         ...
         $elementsPerPage = 1;
         $jadwal_pj_sliced = array_slice($jadwal_pj, $page * $elementsPerPage, $elementsPerPage);
         foreach ($jadwal_pj_sliced as $data_jadwal_pj): ?>
         <div class="row">
             <div class="col-md-12 grid-margin stretch-card">
                 <div class="card">
                     <div class="card-body">
                        <div class="flashdata-rekap-absen" data-flashdata="<?=$this->session->flashdata('message_rekap_absen');?>">
                        </div>
                        <?php if (!empty($data_jadwal_pj)): ?>
                            <?php if (!empty($cek_rekap)): ?>
                                <?php
                                $cek_rekap_kelas = NULL;
                                foreach ($cek_rekap as $rekap) {
                                    if ($data_jadwal_pj['kelas_jadwal'] == $rekap['kelas_rekap']){
                                        $cek_rekap_kelas = TRUE;
                                        $at_rekap = $rekap['at_rekap'];
                                    }
                                }
                                if ($cek_rekap_kelas == TRUE): ?>
                                        <div class="py-5">
                                            <h4 class="text-center mb-3">
                                               Ruang <?=$ruang?> Shift <?=$shift?> telah diabsen oleh <?=$at_rekap?>
                                            </h4>
                                            <a href="<?=base_url('list_rekap/rekap/'.$ruang.'/'.$shift)?>">
                                                <h5 class="text-center">Lihat Rekap</h5>
                                            </a>
                                            <?php if (count($jadwal_pj) > 1):
                                                if ($page == 1) {
                                                    $page = 0;
                                                } else{
                                                    $page = $page+1;
                                                }?>
                                                <h6 class="mt-5 text-center">Diruangan ini sedang berlangsung praktikum lain.<br>
                                                    <a href="?page=<?=$page?>">Klik disini untuk rekap praktikum lain</a>
                                                </h6>
                                            <?php endif ?>
                                            <div class="row mt-5">
                                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <form id="form_asisten" action="<?=base_url('absen_action')?>" method="post" class="forms-sample needs-validation" novalidate>
                                            ...
                                            <div class="form-group row mb-0">
                                                ...
                                                <div class="col-sm-8">
                                                    <input readOnly type="text" value="<?=$data_jadwal_pj['hari']?>" class="form-control" name="hari" id="hari" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-0 mt-2">
                                                ...
                                                <?php if (substr($data_jadwal_pj['ruang'], 0, 1) == "H") {
                                                    if ($data_jadwal_pj['shift'] == "1") {
                                                        $jam = "08:00 - 10:00";
                                                    } elseif (($data_jadwal_pj['shift'] == "2")){
                                                        $jam = "10:00 - 12:00";
                                                    } elseif (($data_jadwal_pj['shift'] == "3")){
                                                        $jam = "12:00 - 14:00";
                                                    } elseif (($data_jadwal_pj['shift'] == "4")){
                                                        $jam = "14:00 - 16:00";
                                                    } elseif (($data_jadwal_pj['shift'] == "5")){
                                                        $jam = "16:00 - 18:00";
                                                    }
                                                } elseif(substr($data_jadwal_pj['ruang'], 0, 1) == "E"){
                                                    if ($data_jadwal_pj['shift'] == "1") {
                                                        $jam = "07:30 - 09:30";
                                                    } elseif (($data_jadwal_pj['shift'] == "2")){
                                                        $jam = "09:30 - 11:30";
                                                ...
                                                <div class="col-sm-8">
                                                    <input readOnly type="hidden" value="<?=$data_jadwal_pj['shift']?>" class="form-control" name="shift" id="shift" autocomplete="off">
                                            ...
                                            <div class="form-group row mb-0 mt-2">
                                                ...
                                                <div class="col-sm-8">
                                                    <input readOnly type="text" value="<?=$data_jadwal_pj['matprak']?>" class="form-control" name="materi" id="materi" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-0 mt-2">
                                                <div class="col-sm-2 offset-sm-1">
                                                ...
                                                <div class="col-sm-8">
                                                    <input readOnly type="text" value="<?=$data_jadwal_pj['kelas_jadwal']?>" class="form-control" name="kelas" id="kelas" autocomplete="off">
                                                </div>
                                            </div>
                                            <table class="table mt-4">
                                                ...
                                                <tbody class="field_wrapper">
                                                    <tr>
                                                        <td width="40%">
                                                            <select class="pj" name="pj" id="pj" required>
                                                                <option value="">--Pilih PJ--</option>
                                                                <?php foreach ($asisten_opt as $asisten): ?>\
                                                                    <option <?php if($data_jadwal_pj['nama_lengkap'] === $asisten['nama_lengkap']){?>selected="selected"<?php } ?> value="<?=$asisten['nama_lengkap']?>"><?=$asisten['nama_lengkap']?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                        </td>
                                                        <td width="40%">
                                                            <select class="pengganti_pj" name="pengganti_pj" id="pengganti_pj">
                                                    ...
                                                    <?php foreach ($jadwal_asisten as $asist): ?>
                                                        <?php if ($asist['matprak'] == $data_jadwal_pj['matprak']): ?>
                                                        <tr>
                                                            <td width="40%">
                                            ...
                                            ?>
                                                <h6 class="mt-3">Diruangan ini sedang berlangsung praktikum lain.
                                                    <a href="?page=<?=$page?>">Klik disini untuk rekap praktikum lain</a>
                                                </h6>
                                            <?php endif ?>
